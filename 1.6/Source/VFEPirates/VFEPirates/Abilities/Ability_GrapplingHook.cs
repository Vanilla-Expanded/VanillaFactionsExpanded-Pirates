...
namespace VFEPirates
{
    public class Ability_GrapplingHook : Ability_ShootProjectile
    {
        ...
        public TargetingParameters targetParamsSelf => new TargetingParameters
        {
            canTargetSelf = true,
        ...
        public override TargetingParameters targetParams => Loaded ? base.targetParams : targetParamsSelf;
