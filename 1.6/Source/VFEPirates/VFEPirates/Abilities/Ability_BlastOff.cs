...
namespace VFEPirates
{
    ...
    public class Ability_BlastOff : Ability
    {
        ...
        {
            if (holder.TryGetComp<CompApparelReloadable>().RemainingCharges < FuelConsumption)
            {
        ...
        protected override TaggedString WorldTargetingLabel(GlobalTargetInfo target)
        {
        ...
        public override void Cast(params GlobalTargetInfo[] targets)
        {
            ...
            var comp = holder.TryGetComp<CompApparelReloadable>();
            ...
            activeDropPawn.Contents = new ActiveTransporterInfo();
        ...
        protected override void LeaveMap()
        {
            ...
            for (var i = 0; i < tmpActiveDropPods.Count; i++)
            {
                ...
                if (flyShipLeaving != null && flyShipLeaving.groupID == groupID)
                {
                    ...
                    travelingPawn.AddTransporter(flyShipLeaving.Contents, true);
    ...
    public class ActiveDropPawn : ActiveTransporter
    {
        public Pawn pawn;
        public override Graphic Graphic => pawn.Graphic;
    ...
    public class TravelingPawn : TravellingTransporters
    {
        ...
        public void ArrivedOverride()
        {
            ...
            if (arrivalAction == null || !arrivalAction.StillValid(podsField.GetValue<List<ActiveTransporterInfo>>(), destinationTile))
            {
                arrivalAction = null;
                var maps = Find.Maps;
            ...
            if (arrivalAction != null && arrivalAction.ShouldUseLongEvent(podsField.GetValue<List<ActiveTransporterInfo>>(), destinationTile))
                LongEventHandler.QueueLongEvent(delegate { AccessTools.Method(typeof(TravellingTransporters), "DoArrivalAction").Invoke(this, null); },
                    "GeneratingMapForNewEncounter", false, null);
            else
                AccessTools.Method(typeof(TravellingTransporters), "DoArrivalAction").Invoke(this, null);
        }
    ...
    public class PawnArrivalAction_LandInSpecificCell : TransportersArrivalAction_LandInSpecificCell
    {
        ...
        public void DropTravelingPawns(List<ActiveTransporterInfo> dropPods, IntVec3 near, Map map)
        {
        ...
        public void MakePawnDropAt(IntVec3 c, Map map, ActiveTransporterInfo info)
        {
