...
namespace VFEPirates
{
    ...
    internal class ScenPart_LowOrbitCrash : ScenPart
    {
        ...
        private bool TryFindShipChunkDropCell(ThingDef chunk, IntVec3 nearLoc, Map map, out IntVec3 pos) => CellFinderLoose.TryFindSkyfallerCell(chunk, map,TerrainAffordanceDefOf.Walkable, out pos, nearLoc: nearLoc, nearLocMaxDist: 15);
        ...
        private void MakeDropPodAt(IntVec3 c, Map map, ActiveTransporterInfo info)
        {
