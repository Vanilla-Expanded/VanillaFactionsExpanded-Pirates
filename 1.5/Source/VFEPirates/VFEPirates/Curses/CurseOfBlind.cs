...
namespace VFEPirates
{
    public class CurseOfBlind : CurseWorker
    {
        ...
        {
            Patch(original: AccessTools.Method(typeof(LetterStack), nameof(LetterStack.ReceiveLetter),
                parameters: new Type[] { typeof(Letter), typeof(string), typeof(int), typeof(bool) }),
