...
namespace VFEPirates
{
	public class CurseOfGreed : CurseWorker
	{
        ...
        {
            Patch(AccessTools.Method(typeof(Mineable), "TrySpawnYield", new Type[] { typeof(Map), typeof(bool), typeof(Pawn) }), transpiler: AccessTools.Method(typeof(CurseOfGreed), nameof(Transpiler)));
        }
